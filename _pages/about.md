...
I regularly teach [CS 3630 "Introduction to Perception & Robotics"](https://dellaert.github.io/26F-3630/) and [Advanced Mobile Robotics](https://dellaert.github.io/26S-AMR/).

From 2022-2024 I was CTO at [Verdant Robotics](https://www.verdantrobotics.com/), a Bay Area startup that is creating the most advanced multi-action robotic farming implement, designed for superhuman farming! In 2025 I switched to a part-time role as Chief AI officer after returning to Georgia Tech.
...
In 2015-2016 I served as Chief Scientist at [Skydio](https://www.skydio.com), a startup founded by MIT grads to create intuitive interfaces for micro-aerial vehicles. In 2016-2018, I served as Technical Project Lead at Facebook's "Building 8" hardware division within [Facebook Reality Labs](https://tech.fb.com/ar-vr/). Finally, I was a part-time Research Scientist at [Google AI](https://ai.google/) from 2020-2022, before I joined Verdant Robotics.

My research is in the overlap between robotics and computer vision, and I am particularly interested in graphical model techniques to solve large-scale problems in mapping, 3D reconstruction, and increasingly model-predictive control. The GTSAM toolbox embodies many of the ideas my research group has worked on in the past few years and is available at [gtsam.org](https://gtsam.org) and [the GTSAM Github repo](https://github.com/borglab/gtsam/pulse/monthly). GTSAM 4.3 was just released.
